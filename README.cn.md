...
![just](https://repo.x-cmd.io/just.svg?lang=zh)
...
合计: **60,009** 行代码（覆盖前 5 种语言、共 **280** 个文件）。
...
- **最新版本**: `1.58.0` (2026-08-03)
- **最近提交**: 2026-09-01
- **Release 含资产**: 12 个

## 流行度

- **Star**: 35,766 · **Fork**: 845 · **开放 issue**: 1,472 · **贡献者**: 213

## 累计统计

- **发布数**: 146 · **已合并 PR**: 1797 · **开放 PR**: 0 · **已关闭 issue**: 1301 · **开放 issue**: 171 · **提交数**: 1979

## 最近活动

| 时间窗口 | 起始 | 发布 | 已合并 PR | 开放 PR | 已关闭 issue | 开放 issue | 提交 |
|---|---|---:|---:|---:|---:|---:|---:|
| 30d | 2026-08-14 | 0 | 3 | 0 | 3 | 3 | 3 |
| last60d | 2026-07-15 | 2 | 16 | 0 | 18 | 5 | 17 |
| 90d | 2026-06-15 | 7 | 216 | 0 | 44 | 11 | 223 |
| last180d | 2026-03-17 | 13 | 394 | 0 | 91 | 22 | 405 |
| 360d | 2025-09-18 | 21 | 493 | 0 | 178 | 37 | 496 |
| last720d | 2024-09-23 | 32 | 657 | 0 | 368 | 89 | 658 |
...
在 [repology.org](https://repology.org/project/just) 上共有 **138** 个发行版报告此项目。**43** 个 ✅ 已是最新上游版本，**79** 个 ⚠️ 使用旧版本。
...
just 的安装元数据由 [x-cmd/install](https://github.com/x-cmd/install) 索引维护——这是一份由 x-cmd 在安装时读取的精选 YAML 包列表。如果 `just` 缺失、过期，或安装行为有问题，欢迎在该 repo 提 issue 或 PR：

- **提交 issue**: <https://github.com/x-cmd/install/issues/new>
- **编辑包条目**: <https://github.com/x-cmd/install/edit/main/just.yml>（或索引实际使用的路径）

本页面的数据（card / loc / scorecard / release）由 [x-cmd-install-action](https://github.com/x-cmd-install/x-cmd-install-action) 自动采集，每日重新生成。**安装行为**（版本选择、平台差异、依赖处理）的改进应提交到上游索引。

_数据快照: `data/card/260913.yml` · 2026-09-13T05:46:09Z._
